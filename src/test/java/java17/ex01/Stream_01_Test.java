...
public class Stream_01_Test {
	...
	public void test_stream_filter() throws Exception {
		...
		List<Pizza> result = pizzas.stream().filter(v -> v.getPrice() >= 1300).toList();
//		System.out.println(result);
	...
	public void test_stream_filter_collect_counting() throws Exception {
		...
		long result = pizzas.stream().filter(v -> v.getPrice() >= 1300).count();
//		System.out.println(result);
	...
	public void test_stream_anyMatch() throws Exception {
		...
		Boolean result1 = pizzas.stream().anyMatch(v -> v.getPrice() >= 1300);
//		System.out.println(result1);

		// TODO valider si au moins une pizza à un prix >= 2000
		Boolean result2 = pizzas.stream().anyMatch(v -> v.getPrice() >= 2000);
//		System.out.println(result2);
	...
	public void test_stream_allMatch() throws Exception {
		...
		Boolean result1 = pizzas.stream().allMatch(v -> v.getPrice() >= 1300);
//		System.out.println(result1);

		// TODO valider que toutes les pizzas ont un prix >= 900
		Boolean result2 = pizzas.stream().allMatch(v -> v.getPrice() >= 900);
//		System.out.println(result2);
	...
	public void test_stream_noneMatch() throws Exception {
		...
		Boolean result1 = pizzas.stream().noneMatch(v -> v.getPrice() >= 2000);
//		System.out.println(result1);
	...
	public void test_stream_findFirst() throws Exception {
		...
		Optional<Order> result = orders.stream().filter(v -> v.getCustomer().getFirstname().equals("sophie"))
				.findFirst();
//		System.out.println(result);
	...
	public void test_stream_filter_adv() throws Exception {
		...
		Optional<Order> result = orders.stream()
				.filter(v -> v.getPizzas().stream().allMatch(p -> p.getName().equals("Pépéroni"))).findFirst();
		System.out.println(result);
